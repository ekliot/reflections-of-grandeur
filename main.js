...
(function() {
  var TypeQueue, app, content_bob, content_me, content_pre, sleep, write_to;

  TypeQueue = class TypeQueue {
    constructor(div, content) {
      this.div = div;
      this.content = content;
      this.cursor = "<a class=\"cursor\">_</a>";
      this.span = "<span></span>";
      this.p_span = `<p>${this.span}</p>`;
      this.queue = [];
      this.idle = false;
      this.div.append(this.p_span);
      this.lastp = this.div.children().last();
      this.push(this.content["root"]);
      this.toggle();
    }
    ...
    toggle() {
      ...
      if (this.idle) {
        ...
        this.lastp.children(".cursor").remove();
        ...
        // if toggling to idle
        this.lastp.append(this.cursor);
        // bind onclick to cursor
        this.lastp.children("a.cursor").on('click', () => {
          return this.shift();
        });
    ...
    shift() {
      var object, ref;
      object = this.queue.shift();
      if (object == null) {
        return;
      }
      if ((object.next != null) && (this.content[object.next] != null)) {
        this.queue.push(this.content[object.next]);
      }
      this.toggle();
      return this.write(object.text, (ref = object.after) != null ? ref : function() {});
    }

    async write(subj, cb) {
      var contents, s, sub_target, target, typer;
      target = this.lastp.children().last();
      typer = this.make_typer(target[0]);
      ...
      if (subj[0] != null) {
        ...
        if (s.match(/(<[^>]*>)/)) {
          ...
          return this.make_typer(sub_target[0]).type(contents, () => {
            sub_target.html(contents);
            this.write(subj, cb);
            if (sub_target[0].tagName === "A") {
              return sub_target.click(function() {
          ...
          return typer.type(s, () => {
            return this.write(subj, cb);
          });
        }
      } else {
        this.carriage(target);
        cb();
    ...
    kill() {
      return this.lastp.children(".cursor").remove();
    }
  ...
  write_to = async function(who, msg) {
    var target;
    if (who === 'bob') {
      target = App.bob;
    } else {
    ...
    target.toggle();
    return target.write(msg, function() {});
  };
  ...
  content_bob = {
    ...
    strangeadmiration: {
      ...
      next: "oldreverence",
      after: function() {
        return write_to("me", "Whatever happened to the honest tools of an artisan?");
      }
    },
    oldreverence: {
    ...
    methinks: {
      ...
      next: "insecurity",
      after: function() {
        return write_to('me', "Crom knows there's little to be satisfied with today.");
      }
    },
    insecurity: {
    ...
    wanderingtexan: {
      ...
      after: function() {
        ...
        return write_to('me', "Howard's Texan roots were the bread and butter of his storytelling, something I may indeed find envy in.");
      }
    },
    indomitable: {
    ...
    intoxicated: {
      ...
      next: "fellowships",
      after: function() {
        return write_to('me', "A beautiful thing, friendship, to those that can find it - and to those that cannot.");
      }
    },
    fellowships: {
    ...
    lovecraft: {
      ...
      next: "scarceface",
      after: function() {
        return write_to('me', "At times I wonder, of the people I have yet to cross, would any friendship be as enriching as these?");
      }
    },
    scarceface: {
    ...
    motherscomforts: {
      ...
      next: "dimmed",
      after: function() {
        return write_to('me', "It would be my mother's own efforts that opened my mind to a world and people worth my admiration.");
      }
    },
    dimmed: {
      ...
      next: "caretaker",
      after: function() {
        return write_to('me', "I don't recall much of my own mother's illness, but for a dusky haze of scattered memories.");
      }
    },
    caretaker: {
      ...
      next: "suicide",
      after: function() {
        return write_to('me', "I wish, pointlessly, I could have been a better son.");
      }
    },
    suicide: {
      ...
      next: "successmeaning",
      after: function() {
        return write_to('me', "I have yet to find again who I was, those years before.");
      }
    },
    successmeaning: {
      ...
      next: "frightfullove",
      after: function() {
        return write_to('me', "Can I hope to be fulfilled by success, or is it just a hollow promise to distract me from my own terrors?");
      }
    },
    frightfullove: {
    ...
    vulnerable: {
      ...
      next: "",
      after: function() {
        return write_to('bob', "You risk losing it.");
      }
    }
  };
  ...
  content_me = {
    ...
    scratchthat: {
      ...
      next: "ashamedof",
      after: function() {
        return $(".scratchthat").css('text-decoration', 'line-through');
      }
    },
    ashamedof: {
    ...
    braggadocious: {
      ...
      next: "dontcare",
      after: function() {
        return write_to('bob', "A fiery independence burned in him, to <a href=\"https://en.wikipedia.org/wiki/Character_of_Robert_E._Howard#Resentment_of_authority\">shun</a> authority and subservience.");
      }
    },
    dontcare: {
    ...
    outskirts: {
      ...
      next: "naturallyweird",
      after: function() {
        return write_to('bob', "<span class=\"quote\">\"Never the less, it is no light thing to enter into a profession absolutely foreign and alien to the people among which one's lot is cast; a profession which seems as dim and faraway and unreal as the shores of Europe.\"</span>");
      }
    },
    naturallyweird: {
    ...
    lookaround: {
      ...
      after: function() {
        return write_to('bob', "<span class=\"quote\">\"He’s trying to tell people he’s a writer and writers have a right to be odd. Since they think he’s crazy, anyway, he’ll show them just how crazy he can be.\" - Novalyne Price</quote>");
      }
    },
    dreamedandfound: {
    ...
    woven: {
      ...
      next: "conversion",
      after: function() {
        return write_to('bob', "<span class=\"quote\">\"We like to come here where there are big rocks and caves so we can play make-believe. Some day I am going to be an author and write stories about pirates and maybe cannibals. Would you like to read them?\"</span>");
      }
    },
    // root: {
    conversion: {
    ...
    guidance: {
      ...
      next: "bycrom",
      after: function() {
        return write_to('bob', "In no small part, I suspect those same tales gave meaning to the world he lived in, and helped him battle those very same demons.");
      }
    },
    bycrom: {
